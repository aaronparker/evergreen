...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-AdobeAcrobatProDC', 'Get-AdobeAcrobatReaderDC', 'Get-MicrosoftBicep',
               'Get-AdobeBrackets', 'Get-AdoptOpenJDK', 'Get-BISF', 
               'Get-CitrixAppLayeringFeed', 'Get-AtlassianBitbucket',
               'Get-CitrixApplicationDeliveryManagementFeed', 'Get-TelegramDesktop',
               'Get-CitrixEndpointManagementFeed', 'Get-CitrixGatewayFeed', 
               'Get-CitrixHypervisorFeed', 'Get-CitrixLicensingFeed', 
               'Get-CitrixReceiverFeed', 'Get-CitrixSdwanFeed', 'Get-Gimp',
               ...
               'Get-Fork', 'Get-FoxitReader', 'Get-GitforWindows', 'Get-GitHubAtom', 
               ...
               'Get-Microsoft.NET', 'Get-MicrosoftEdge', 'Get-MicrosoftFSLogixApps', 
               'Get-MicrosoftOffice', 'Get-MicrosoftOneDrive', 
               'Get-MicrosoftPowerShell', 'Get-MicrosoftPowerToys', 
               'Get-MicrosoftSsms', 'Get-MicrosoftTeams', 'Get-BitwardenDesktop',
               ...
               'Get-TelerikFiddlerEverywhere', 'Get-Terminals', 
               'Get-VastLimitsUberAgent', 'Get-VercelHyper', 'Get-VideoLanVlcPlayer', 
               'Get-VMwareTools', 'Get-Win32OpenSSH', 'Get-WinMerge', 'Get-WinSCP', 
               'Get-WixToolset', 'Get-Zoom')
