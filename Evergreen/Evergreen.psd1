...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-ControlUpAgent', 'Get-ControlUpConsole', 'Get-Cyberduck', 
               'Get-dnGrep', 'Get-FileZilla', 'Get-Fork', 'Get-FoxitReader', 'Get-Gimp', 
               'Get-GitforWindows', 'Get-GitHubAtom', 'Get-GitHubRelease', 'Get-Good', 
               ...
               'Get-Microsoft365Apps', 'Get-MicrosoftAzureDataStudio', 
               ...
               'Get-NETworkManager', 'Get-NotepadPlusPlus', 'Get-OpenJDK', 'Get-OpenShellMenu', 
