...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-CitrixAppLayeringFeed', 'Get-Win32OpenSSH',
               'Get-CitrixApplicationDeliveryManagementFeed', 'Get-Microsoft.NET',
               ...
               'Get-MicrosoftPowerShellCore', 'Get-MicrosoftPowerToys', 'Get-MicrosoftSsms', 
