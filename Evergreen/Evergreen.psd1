...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-CitrixAppLayeringFeed', 'Get-Handbrake', 'Get-VastLimitsUberAgent',
               'Get-CitrixApplicationDeliveryManagementFeed', 'Get-OpenShellMenu',
               'Get-CitrixEndpointManagementFeed', 'Get-CitrixGatewayFeed', 
               'Get-CitrixHypervisorFeed', 'Get-CitrixLicensingFeed', 
               'Get-CitrixReceiverFeed', 'Get-CitrixSdwanFeed', 'Get-WinSCP',
               ...
               'Get-GoogleChrome', 'Get-Greenshot', 'Get-JamTreeSizeFree', 
               'Get-JamTreeSizeProfessional', 'Get-LibreOffice', 'Get-MicrosoftEdge', 
               'Get-MicrosoftFSLogixApps', 'Get-MicrosoftOffice', 
               'Get-MicrosoftOneDrive', 'Get-MicrosoftPowerShellCore', 
               'Get-MicrosoftSsms', 'Get-MicrosoftTeams', 'Get-KeePass',
