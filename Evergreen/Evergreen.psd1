...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-AdoptOpenJDK', 'Get-BISF', 'Get-CitrixAppLayeringFeed', 
               'Get-CitrixApplicationDeliveryManagementFeed', 'Get-MicrosoftVisualStudio',
               ...
               'Get-FoxitReader', 'Get-GitforWindows', 'Get-GitHubAtom', 
               ...
               'Get-MicrosoftOffice', 'Get-MicrosoftOneDrive', 'Get-Fork',
               'Get-MicrosoftPowerShell', 'Get-MicrosoftPowerToys', 
               'Get-MicrosoftSsms', 'Get-MicrosoftTeams', 'Get-VercelHyper',
               'Get-MicrosoftVisualStudioCode', 'Get-AdobeBrackets',
               ...
               'Get-Win32OpenSSH', 'Get-WinMerge', 'Get-WinSCP', 'Get-WixToolset', 
               'Get-Zoom')
