...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-JamTreeSizeFree', 'Get-JamTreeSizeProfessional', 
               'Get-LibreOffice', 'Get-MicrosoftOffice', 'Get-Cyberduck',
               ...
               'Get-ShareX', 'Get-TeamViewer', 'Get-VideoLanVlcPlayer', 
               'Get-VMwareTools', 'Get-WinMerge', 'Get-Zoom')
