...
FunctionsToExport = @('Export-EvergreenApp', 'Export-EvergreenManifest',
               'Find-EvergreenApp', 'Get-EvergreenApp', 'Get-EvergreenLibrary',
               'Get-EvergreenLibraryApp', 'Invoke-EvergreenApp',
               'Invoke-EvergreenLibraryUpdate', 'New-EvergreenLibrary',
               'Save-EvergreenApp', 'Test-EvergreenApp', 'Get-EvergreenEndpoint')
