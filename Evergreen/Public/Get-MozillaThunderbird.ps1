Function Get-MozillaThunderbird {
    <#
        ...
        .EXAMPLE
            ...
            Description:
            Returns the version and download URIs for Thunderbird for Windows (en-US).

        .EXAMPLE
            Get-MozillaThunderbird -Language en-GB

            Description:
            Returns the UK English version and download URIs for Thunderbird for Windows.
    #>
    ...
    $thunderbirdVersions = Invoke-WebContent -Uri $res.Get.Update.Uri | ConvertFrom-Json
