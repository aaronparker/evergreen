...
@{
    ...
    FunctionsToExport = @('Get-MozillaFirefoxVersion', 'Get-MozillaFirefoxUri', 'Get-AdobeReaderVersion', 'Get-AdobeReaderUri', `
            'Get-GoogleChromeVersion', 'Get-CitrixReceiverVersion', 'Get-GoogleChromeUri')
